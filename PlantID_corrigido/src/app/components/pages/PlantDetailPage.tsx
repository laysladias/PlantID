            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  {plant.lightIntensityMin}-{plant.lightIntensityMax} lux
                </p>
              </div>
            </div>
        ...
        <Card className="p-4">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-gray-800">{plant.humidity}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Solo:</span>
              <span className="font-medium text-gray-800">{plant.soilType}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Fertilização:</span>
              <span className="font-medium text-gray-800">{plant.fertilization}</span>
            </div>
          </div>
        </Card>
