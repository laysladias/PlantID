...
export function SearchPage() {
  ...
  const handleVoiceSearch = async () => {
    ...
    // Pede a permissão de microfone explicitamente antes de iniciar o
    // reconhecimento de voz. Depender só do SpeechRecognition para isso
    // é pouco confiável em alguns navegadores/PWAs instalados.
