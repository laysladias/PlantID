    ...
    <div className="p-4 space-y-4">
      ...
      <Card className="p-3 bg-gray-50 border-gray-200">
        <p className="text-xs text-gray-600 leading-relaxed">
          <strong>Sobre avisos:</strong> as notificações do navegador só aparecem
          enquanto o app/site estiver aberto (ou em segundo plano no PWA). Em
          hospedagem estática não enviamos e-mail automático de lembrete. Use a
          lista abaixo e o botão <em>Já cuidei</em> para acompanhar o que vence hoje.
        </p>
      </Card>
