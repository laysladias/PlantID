...
import { Plus, AlertTriangle, Trash2, Droplet } from "lucide-react";
import { Card } from "../ui/card";
import { Button } from "../ui/button";
import { toast } from "sonner";
import { getMyPlants, deleteMyPlant, waterMyPlant, MyPlant } from "../../lib/db";
...
export function MyPlantsPage() {
  ...
  const handleWater = async (plantId: string) => {
    ...
    toast.success("Rega registrada! Próximo aviso em ~7 dias.");
    loadPlants();
  };
